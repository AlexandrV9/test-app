export default class Popup {
  ...
  open() {
    ...
    this.setClassElementDOM(".panel_type_pagination-list-cards", "action_popup-open");
    this.setClassElementDOM("header", "action_popup-open");
  }
  ...
  close() {
    ...
    this.removeClassElementDOM(".panel_type_pagination-list-cards", "action_popup-open");
    this.removeClassElementDOM("header", "action_popup-open");
  }

  getElementFromPopupDOM = cls => this.popup.querySelector(cls);
  setClassElementDOM = (selector, cls) => document.querySelector(selector).classList.add(cls);
  removeClassElementDOM = (selector, cls) => document.querySelector(selector).classList.remove(cls);
}